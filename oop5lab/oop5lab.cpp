...
void main()
{
	...
	do
	{
		...
		try
		{
			...
			case 49:	//1 - Load
				clearConsole();
				printf_s("Menu:\n1 - Load brush\n2 - Load contour\n3 - Load data for combined figure\n4 - Exit\n");
				c = _getch();
				clearConsole();
				switch (c)
				{
			...
			case 50:	//2 - Save
				clearConsole();
				printf_s("Menu:\n1 - Save brush\n2 - Save contour\n3 - Save data from combined figure\n4 - Exit\n");
				c = _getch();
				clearConsole();
				switch (c)
				{
				...
				case 50:	//2 - Contour
					...
					break;
				case 51:	//3 - Points to combined
					Combined.save("outbrush_combined.txt", "outcontour_combined.txt");
					printf_s("Combined data saved.");
					break;
				}
				break;
			case 51:	//3 - Draw
