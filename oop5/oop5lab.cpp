			...
			if (_kbhit()) {
				...
				case 52:	//4 - find
					...
					case 49:	//1 - find contour
						printf_s("Set contour color in format R G B : \n");
					...
					case 50:	//2 - find painted
						...
						printf_s("Painted triangle found and buffered!\n");
						break;
					case 51:	//3 - find combined
						...
						printf_s("Combined figure found and buffered!\n");
						break;
					}
					break;
				case 53:	//5 - save
				...
				case 55:	//7 - загрузить треугольник из файла
					clearConsole();
					printf_s("1 - Contour\n2 - Brush for painted triangle\n3 - Internal figure for combined figure\n");
					c = _getch();
					clearConsole();
					switch (c)
					{
					...
					case 50:	//2 - load painted
						...
						printf_s("Brush loaded succesfully!\n");
